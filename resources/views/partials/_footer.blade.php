    ...
    <div class="container pt-5 pb-4">
        <div class="row g-5 d-flex justify-content-around">
            <div class="col-lg-3 col-md-6">
                <a href="index.html">
                    <h1 class="text-white fw-bold d-block">LI<span class="text-secondary">HETI</span> </h1>
                </a>
                <p class="mt-4 text-light">Quality training for a better society</p>
                <img src="{{asset('img/liheti/logo-plain.png')}}" alt="" srcset="">
                <div class="d-flex hightech-link d-none">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="text-white mt-4 d-flex flex-column contact-link">
                    <a href="#" class="pb-3 text-light border-bottom border-primary"><i
                            class="fas fa-map-marker-alt text-secondary me-2"></i> P.o box 94 mbinga</a>
                    <a href="#" class="py-3 text-light border-bottom border-primary"><i
                            class="fas fa-phone-alt text-secondary me-2"></i> +255 765 730 441, +255 653 649 429, +255
                        765 730 441</a>
                    <a href="#" class="py-3 text-light border-bottom border-primary"><i
                            class="fas fa-envelope text-secondary me-2"></i> liheti2023@gmail.com</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center text-md-center">
                <span class="text-light"><a href="#" class="text-secondary">@php echo date('Y');@endphp&nbsp;<i
                            class="fas fa-copyright text-secondary me-2"></i>liheti</a>, All right
                    reserved.</span>
            </div>
